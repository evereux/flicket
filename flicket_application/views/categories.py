...
from flicket_application.flicket_forms import CategoryForm
from flicket_application.flicket_models import FlicketCategory, FlicketDepartment


# create ticket
@app.route(app.config['FLICKETHOME'] + 'categories/<int:department_id>/', methods=['GET', 'POST'])
@login_required
...
@app.route(app.config['FLICKETHOME'] + 'category_edit/<int:category_id>/', methods=['GET', 'POST'])
@login_required
