...
from application.forms import ConfirmPassword
from flicket_application.flicket_models import FlicketTicket, FlicketUploads, FlicketPost, FlicketCategory, FlicketDepartment

# delete ticket
@app.route(app.config['FLICKETHOME'] + 'delete_ticket/<ticket_id>', methods=['GET', 'POST'])
@login_required
...
# delete post
@app.route(app.config['FLICKETHOME'] + 'delete_post/<post_id>', methods=['GET', 'POST'])
@login_required
...
# delete category
@app.route(app.config['FLICKETHOME'] + 'delete/category/<int:category_id>', methods=['GET', 'POST'])
@login_required
def delete_category(category_id=False):
    ...
    if category_id:
        ...
        # we can't delete any categories associated with tickets.
...
# delete department
@app.route(app.config['FLICKETHOME'] + 'delete/department/<int:department_id>', methods=['GET', 'POST'])
@login_required
