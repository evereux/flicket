...
from flicket_application.flicket_forms import ContentForm
from flicket_application.flicket_models import FlicketTicket, FlicketStatus, FlicketPost, FlicketUploads
from flicket_application.flicket_upload import upload_documents, add_upload_to_db
from flicket_application.flicket_functions import block_quoter


# view ticket details
@app.route(app.config['FLICKETHOME'] + 'ticket_view/<ticket_id>/', methods=['GET', 'POST'])
@app.route(app.config['FLICKETHOME'] + 'ticket_view/<ticket_id>/<int:page>/', methods=['GET', 'POST'])
@login_required
